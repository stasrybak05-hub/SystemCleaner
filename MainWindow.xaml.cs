...
namespace SystemCleaner
{
    ...
    // Запитуємо користувача, чи створювати точку відновлення
var createRestorePoint = MessageBox.Show(
    "Створити точку відновлення системи перед очищенням?\n\n" +
    "Рекомендується для безпеки. Це дозволить відновити систему у разі проблем.",
    "Точка відновлення",
    MessageBoxButton.YesNo,
